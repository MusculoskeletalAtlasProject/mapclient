...
class MessageBox(QtWidgets.QMessageBox):
    def __init__(self, icon, title, text, buttons, parent=None, close_after=None):
        ...
        to pass an additional argument (close_after) to specify how long the MessageBox should be displayed for before it terminates.
        ...
        close_after: float, optional
            Specifies the number of seconds that the MessageBox should be displayed for before it closes. If the close_after argument is
            set to zero, the MessageBox will not be displayed.
        """
